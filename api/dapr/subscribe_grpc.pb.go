...
func (c *subscribeClient) GetSubscribe(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListTopicSubscriptionsResponse, error) {
	out := new(ListTopicSubscriptionsResponse)
	err := c.cc.Invoke(ctx, "/api.dapr.Subscribe/GetSubscribe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Subscribe_GetSubscribe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.dapr.Subscribe/GetSubscribe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscribeServer).GetSubscribe(ctx, req.(*emptypb.Empty))
	}
...
var Subscribe_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.dapr.Subscribe",
	...
	Metadata: "api/dapr/subscribe.proto",
}
