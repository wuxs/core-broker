...
type SubscribeByDeviceRequest struct {
	...
	Id           string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	SubscribeIds []uint64 `protobuf:"varint,2,rep,packed,name=subscribe_ids,json=subscribeIds,proto3" json:"subscribe_ids,omitempty"`
}
...
func (x *SubscribeByDeviceRequest) GetSubscribeIds() []uint64 {
	if x != nil {
...
var file_api_subscribe_v1_subscribe_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x04, 0x42, 0x12, 0x92, 0x41,
